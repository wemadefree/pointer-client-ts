...
export class PointerClient extends AxiosClient {
    ...
    async loginWithEmailAndPassword(email: string, password: string) {
        if (this.authClient.loginWithEmailAndPassword) {
            await this.authClient.loginWithEmailAndPassword(email, password);
        }
    }

    async sendPasswordResetEmail(email: string) {
        if (this.authClient.sendPasswordResetEmail) {
            await this.authClient.sendPasswordResetEmail(email);
        }
    }
